...
import PrototypeTile from './PrototypeTile';
...
export default function PrototypeBoard({ tiles, players, transitioningPlayers = {}, animationStyle = 'hop' }: BoardProps) {
  ...
  return (
    ...
    >
      {orderedTiles.map((tile) => {
        ...
        return (
          <PrototypeTile key={tile.position} tile={tile} players={playersOnTile} />
        );
      })}
