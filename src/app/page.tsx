...
const FEATURES = [
  {
    ...
    title: "BELAJAR",
    subtitle: "Trivia Sejarah",
    color: "text-blue-200"
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 md:w-5 md:h-5" fill="none">
        <path d="M12 2 L15 8 L22 9 L17 14 L18 21 L12 17 L6 21 L7 14 L2 9 L9 8 Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      </svg>
    ),
    title: "BERMAIN",
    subtitle: "1-4 Pemain",
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 md:w-5 md:h-5" fill="none">
        <path d="M12 3 L20 7 L20 17 L12 21 L4 17 L4 7 Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        <circle cx="12" cy="12" r="3" fill="currentColor" />
      </svg>
    ),
    title: "MENANG",
    subtitle: "Kumpulkan Skor",
    color: "text-emerald-200"
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 md:w-5 md:h-5" fill="none">
        <path d="M12 4 C12 4 18 2 18 9 C18 15 12 20 12 20 C12 20 6 15 6 9 C6 2 12 4 12 4 Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      </svg>
    ),
    title: "BANGGA",
    subtitle: "Cinta Tanah Air",
    color: "text-rose-200"
  }
];
